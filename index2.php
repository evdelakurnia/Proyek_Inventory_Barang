  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index2.php">
        ...
        <div class="sidebar-brand-text mx-2">FAKULTAS SAINTEK</div>
      </a>
...
<li class="nav-item active">
 ...
 <!-- Heading -->
      <div class="sidebar-heading">
	   ...
	   <li class="nav-item active">
<a class="nav-link collapsed" href="?page=cetak&aksi=tambahcetak">
          <i class="fa fa-print" aria-hidden="true"></i>
          <span>Pengambilan Barang</span> </a>

<a class="nav-link collapsed" href="?page=cetak2&aksi=tambahcetak2">
          <i class="fa fa-print" aria-hidden="true"></i>
		      ...
		      <?php
			   ...
			   if ($page == "cetak") {
				   if ($aksi == "") {
				    ...
				    if ($aksi == "tambahcetak") {
					   include "page//cetak/tambahcetak.php";
				   }
				    if ($aksi == "ubahcetak") {
					   include "page/cetak/ubahcetak.php";
				   }
				   
				    if ($aksi == "hapuscetak") {
					   include "page/cetak/hapuscetak.php";
				   }
			   }			    

			    if ($page == "cetak2") {
				   if ($aksi == "") {
					   include "page/cetak2/cetak2.php";
				   }
				    if ($aksi == "tambahcetak2") {
					   include "page//cetak2/tambahcetak2.php";
				   }
				    if ($aksi == "ubahcetak2") {
					   include "page/cetak2/ubahcetak2.php";
				   }
				   
				    if ($aksi == "hapuscetak2") {
					   include "page/cetak2/hapuscetak2.php";
				   }
			   }
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; 2022 . Sistem Inventaris Barang Fakultas Saintek</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
